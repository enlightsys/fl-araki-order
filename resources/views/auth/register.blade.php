        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-8">
                〒 <input type="text" class="form-control form-zip @error('zip') is-invalid @enderror" name="zip" value="{{ old('zip') }}" placeholder="0001111" onkeyup="AjaxZip3.zip2addr(this, '', 'pref_id', 'city');" maxlength="8" />
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-8">
                <input id="tel" type="text" class="form-control @error('tel') is-invalid @enderror" name="tel" value="{{ old('tel') }}" maxlength="15" />
                @error('tel')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
