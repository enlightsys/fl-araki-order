        ...
        <table class="table table-hover shopping-cart-wrap">
          <thead class="text-muted">
            <tr>
              ...
              <th scope="col" class="text-center text-nowrap">お届け先</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right text-nowrap"> {{ number_format($order->total) }} 円</var></td>
              <td class="text-right"> 
                <a href="/history_detail/{{ $order->id }}" class="btn btn-sm btn-info">詳細</a>
              </td>
            </tr>
            @endforeach
          </tbody>
